package com.example.maca.ex2cameraandroid.rendering;
...
/*
*Esta classe renderiza o plano de fundo do AR a partir do feed da câmera.
*Cria e hospeda a textura ARCore para ser preenchido com a imagem da câmera
*/
public class BackgroundRender {
    ...
    //Aloca e inicializa os recursos do OpenGL necessários ao renderizador em segundo plano.
    public void createOnGlThread(Context context) throws IOException{
        // Gera a textura do background
        ...
        if(numVertices != QUAD_COORDS.length / COORDS_PER_VERTEX){
            throw new RuntimeException("Número inesperado de vértices no BackgroundRenderer");
        }
