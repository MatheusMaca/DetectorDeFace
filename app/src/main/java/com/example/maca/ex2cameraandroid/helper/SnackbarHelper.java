...
public final class SnackbarHelper {
    ...
    public boolean isShowing(){return messageSnackbar != null;}

    //Mostrar a snackbar com uma mensagem
    public void showMessage(Activity activity, String message){ show(activity, message, DismissBehavior.HIDE);}

    //Mostrar a snackbar com um botão de ignorar
    public void showMessageWithDismiss(Activity activity, String message){
        show(activity,message,DismissBehavior.SHOW);
    }

    //Mostra uma snackbar com uma mensagem de erro. Quando dispensado finaliza a activity
